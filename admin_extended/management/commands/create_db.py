...
class Command(BaseCommand):
    ...
    def _create_postgresql(self, db, dbname):
        ...
        try:
            ...
            raise CommandError(f"Could not connect to PostgreSQL: {exc}")
    ...
    def _create_mysql(self, db, dbname):
        ...
        try:
            ...
            raise CommandError(f"Could not connect to MySQL: {exc}")
